...
A regression test exists to keep this from being tidied up.
...
This resolves an early open question, decided here because it is a
schema decision.
...
No ORM, deliberately — adopting one here would decide that question by accident.
